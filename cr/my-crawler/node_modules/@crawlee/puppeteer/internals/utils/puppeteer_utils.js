...
exports.puppeteerUtils = exports.removeInterceptRequestHandler = exports.addInterceptRequestHandler = exports.enqueueLinksByClickingElements = exports.registerUtilsToContext = exports.saveSnapshot = exports.infiniteScroll = exports.gotoExtended = exports.compileScript = exports.cacheResponses = exports.blockResources = exports.blockRequests = exports.parseWithCheerio = exports.injectJQuery = exports.injectFile = void 0;
...
async function saveSnapshot(page, options = {}) {
    ...
    try {
        const store = await core_1.KeyValueStore.open(keyValueStoreName);
        if (saveScreenshot) {
