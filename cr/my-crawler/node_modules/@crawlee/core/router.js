...
class Router {
    ...
    getHandler(label) {
        ...
        if (!label) {
            ...
            throw new errors_1.MissingRouteError(`No default route set up. Please specify 'requestHandler' option or provide default route via 'crawler.router.addDefaultRoute()'.`);
        }
        throw new errors_1.MissingRouteError(`Route not found for label '${String(label)}' and no default route set up!`);
    }
    /**
